...
if(isset($_POST['payment'])){
					...
					if($validated_data === false) {
							...
							$stockid=mysqli_real_escape_string($myconnection,$_POST['stockid']);
						
							$bill_no =mysqli_real_escape_string($myconnection,$_POST['bill_no']);
							$customer=mysqli_real_escape_string($myconnection,$_POST['supplier']);
							$address=mysqli_real_escape_string($myconnection,$_POST['address']);
							$contact=mysqli_real_escape_string($myconnection,$_POST['contact']);			   
							...
							$quty=$_POST['quty'];
							$date=mysqli_real_escape_string($myconnection,$_POST['date']);
							$sell=$_POST['sell'];
							$total=$_POST['total'];
							$payable=$_POST['subtotal'];
							$description=mysqli_real_escape_string($myconnection,$_POST['description']);
							$due=mysqli_real_escape_string($myconnection,$_POST['duedate']);
							$payment=mysqli_real_escape_string($myconnection,$myconnection,$_POST['payment']);
							$discount=mysqli_real_escape_string($myconnection,$_POST['discount']);
                                                        if($discount==""){
                                                            $discount=00;
                                                        }
							$dis_amount=mysqli_real_escape_string($myconnection,$_POST['dis_amount']);
							if($dis_amount==""){
                                                            $dis_amount=00;
                                                        }
							...
							$tax_dis=mysqli_real_escape_string($myconnection,$_POST['tax_dis']);
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form "  border="0" cellspacing="0" cellpadding="0">
                    <tr>  <td>&nbsp; </td> <td>&nbsp; </td>
                      ...
                      <td><input name="bill_no" placeholder="ENTER BILL NO" requiered="" type="text" id="bill_no" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
