...
<body>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
	     ...
	     $id=mysqli_real_escape_string($myconnection,$_POST['id']);
			$balance=mysqli_real_escape_string($myconnection,$_POST['balance']);
			$payment=mysqli_real_escape_string($myconnection,$_POST['paid']);
			$customer=mysqli_real_escape_string($myconnection,$_POST['customer']);
			$subtotal=mysqli_real_escape_string($myconnection,$_POST['total']);
			$newpayment=mysqli_real_escape_string($myconnection,$_POST['new_payment']);
                        if($newpayment==""){
                        $newpayment=00;
                        }
