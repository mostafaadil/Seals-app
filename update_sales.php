...
<body>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			$billnumber=mysqli_real_escape_string($myconnection,$_POST['bill_no']);
			$autoid1=mysqli_real_escape_string($myconnection,$_POST['id']);
			...
			$payment=mysqli_real_escape_string($myconnection,$_POST['payment']);
			$balance=mysqli_real_escape_string($myconnection,$_POST['balance']);
			...
			$due=$mysqldate;
			$mode=mysqli_real_escape_string($myconnection,$_POST['mode']);
			...
			$totalt=$_POST['total'];
			$payable=mysqli_real_escape_string($myconnection,$_POST['subtotal']);
			...
			$subtotal=mysqli_real_escape_string($myconnection,$_POST['payable']);
