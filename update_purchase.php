...
<body>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			$autoid=mysqli_real_escape_string($myconnection ,$_POST['id']);
			
			$supplier=mysqli_real_escape_string($myconnection ,$_POST['supplier']);
			...
			$subtotal=mysqli_real_escape_string($myconnection ,$_POST['subtotal']);
